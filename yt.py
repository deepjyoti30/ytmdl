...
from song import getChoice
import os
import youtube_dl
from defaults import DEFAULT

def GRAB_SONG(link):
    '''Function to grab the song from youtube
    '''
...
def search(querry, lim = 5):
    '''Function to search the song in youtube
        Querry is the keyword, i:e name of the song 
        lim is the number of songs that will be added to video
        array and returned
    '''
